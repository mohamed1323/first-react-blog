            ...
            <nav class="flex items-center justify-between h-16 lg:h-20">
                <div class="flex-shrink-0">
                    <a href="#" title="" class="flex">
                        <img class="w-auto h-8 lg:h-10" src="mohamed.JPG" alt="" />
                    </a>
                </div>
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-10">
                    ...
                    <a href="#" title="" class="text-base font-medium text-white"> Tech </a>
                </div>
    ...
    <nav class="flex flex-col justify-between w-full max-w-xs min-h-screen px-4 py-10 bg-black sm:px-6 lg:hidden">
        ...
        <div class="flex flex-col flex-grow h-full">
            <nav class="flex flex-col flex-1 mt-10 space-y-2">
                ...
                <a href="#" title="" class="flex w-full py-2 font-medium text-white transition-all duration-200 focus:text-opacity-70"> Tech </a>
            </nav>
